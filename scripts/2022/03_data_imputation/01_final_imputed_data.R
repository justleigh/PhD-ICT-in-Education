# ----------------------------------------------
# PISA 2022 Final Imputation and Audit for Cleaned_17
# ----------------------------------------------
# Purpose: This script prepares the final imputed version of the PISA 2022 cleaned dataset by:
# 1. Converting 'random_skip' values to NA to standardize missingness.
# 2. Handling 'valid_skip' responses by:
#    - Imputing meaningful values for selected groups of variables (e.g., "None", "No", "Career guidance is not offered").
#    - Dropping unused factor levels after imputations.
# 3. Imputing remaining NA values:
#    - Using the median for numeric variables.
#    - Using the mode for factor, character, and ordered factor variables.
# 4. Converting 'Flagged/Not flagged' quality control variables to factors.
# 5. Saving the finalized Cleaned_17 dataset in both CSV and RDS formats.
# 6. Auditing the dataset to summarize variable classes, missingness, skips, number of factor levels, and ordered status.
# 7. Saving the audit summary to a structured CSV file.
# ----------------------------------------------
...
output_path <- "data/private/processed/2022/pisa2022_cleaned_17_final_imputed_data.csv"
...
# 1. Load cleaned_17
input_path <- "data/private/processed/2022/pisa2022_cleaned_17_final_imputed_data.rds"
df <- readRDS(input_path)
...
# 3. Save Audit Output
output_path <- "data/private/interim/2022/pisa2022_cleaned_17_audit.csv"
