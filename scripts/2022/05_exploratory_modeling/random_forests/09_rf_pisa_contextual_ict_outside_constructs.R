...
# --------------------------------------
# This RF Script:
# - Identifies all non-input predictors related to out-of-school learning contexts using two frameworks:
#     • ICT-related variables defined by the PISA ICT Outside-Class Framework
...
#     • Their broad_learning_context is "Out of School" or "In and Out"
...
#     • pisa_ict_home_construct and pisa_ict_home_domain columns
...
output_folder_base <- "output/private/exploratory_data_analysis/2022/random_forests/pisa_contextual_ict_outside/constructs"
