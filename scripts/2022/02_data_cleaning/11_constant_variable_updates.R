# --------------------------------------
# PISA 2022 Removal of Constant Variables and Metadata Update
# --------------------------------------
# Purpose:
# - Identify and remove variables that contain only a single constant value across all observations.
# - Ensure dataset variability by eliminating non-informative variables.
# - Update the variable mapping table to reflect the exclusion of constant variables.
# - Modify the response summary table to document the removal decision.
# - Save the cleaned dataset and revised metadata tables for transparency and reproducibility.
