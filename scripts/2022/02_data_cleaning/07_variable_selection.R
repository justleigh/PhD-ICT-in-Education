# --------------------------------------
# PISA 2022 Variable Selection and High-Missingness Student Exclusion
# --------------------------------------
# Purpose:
# - Select relevant variables from the student questionnaire while excluding predefined variables.
# - Compute missing data statistics, including counts of NA, 98, and 99 responses.
# - Identify students with excessive missing data (>20% missing responses) for exclusion.
# - Ensure data quality by removing cases that could introduce bias or inconsistencies.
# - Save the cleaned dataset and a detailed missing data summary for transparency and further analysis.
